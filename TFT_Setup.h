...
// Define the driver and display dimensions
#define ST7789_DRIVER     // Full configuration of driver
#define TFT_WIDTH  135
#define TFT_HEIGHT 240

// Define offsets for this particular display
...
#define TFT_BL    16   // LED backlight
